  ...
  return (
    ...
    {!selectedConvo?  <div  className='left h-screen'> <Left/> </div>  : ( <>
     <div className='h-screen w-full overflow-hidden'>
      <div className='flex h-[10vh] w-full bg-slate-950'> <GoArrowLeft className='text-4xl ml-1  mt-5 bg-slate-950' /> 
       <Chatuser/>
     
      </div>
    <div  className='tan py-2  overflow-y-auto ' style={{maxHeight:'calc(88vh - 6vh)'}} >

    <Messages/>
    </div>
    <div className='type h-[5vh] '>
    <Type/>
    </div>
    </div>
    </>  )}
